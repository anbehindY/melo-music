...
const Navigation = () => {
	...
	return (
		<nav className='flex items-center justify-between flex-wrap px-6 h-[99px] bg-glassy-bg backdrop-filter shadow-lg sticky top-0 w-full z-50 lg:h-[125px] lg:px-16'>
