		...
		<footer>
			<div className='flex flex-col gap-8 items-center justify-center text-center pt-8 py-10 border-b-[1px] border-[#5B5858] w-[90%] mx-auto lg:flex-row lg:justify-between'>
				<ul className='text-[16px] flex flex-col gap-2 leading-5 lg:items-start'>
					...
					<li className='hover:text-[#FF5276] cursor-pointer'> Blog</li>
					<li className='hover:text-[#FF5276] cursor-pointer'><Link href='/support'>Support</Link></li>
				</ul>
				<ul className='text-[16px] flex flex-col gap-2 leading-5 lg:items-start'>
					<li className='font-bold !leading-7'>Melo</li>
					<li className='hover:text-[#FF5276] cursor-pointer'> About Us</li>
					<li className='hover:text-[#FF5276] cursor-pointer'> Career</li>
				...
				<ul className='text-[16px] flex flex-col gap-2 leading-5 lg:items-start'>
					...
					<li className='hover:text-[#FF5276] cursor-pointer'>Terms of Use</li>
				</ul>
