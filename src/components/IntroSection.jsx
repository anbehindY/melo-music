				...
				<div className='flex flex-col items-center lg:flex-row-reverse'>
					...
					<div className='flex flex-col items-center gap-[12px] w-full lg:items-start lg:gap-0'>
						<h1 className='text-[39px] gradient lg:text-[96px] lg:leading-[93px] lg:w-[510px] lg:mb-6'>
							Melo <span className='text-white font-semibold'>to your</span>{' '}
							Heart
						</h1>
					...
					<button className='flex justify-center mx-auto items-center w-[40px] h-[40px] mt-12 rounded-full border-[3px] border-white hover:border-none hover:bg-gradient-to-r from-[#F857A6] via-pink-500 to-[#FF5858]'>
